...
use App\Exceptions\ConsumerEventConfigNotFoundException;
use App\Helper\RdKafkaProducerHelper;
use App\WorkWechat\Events\EventNameDefine;
...
%s
str;
        $obj        = new \App\Helper\RdKafkaConsumerHelper($brokerList, $topicList, $this->groupId, $kafkaOptions);
